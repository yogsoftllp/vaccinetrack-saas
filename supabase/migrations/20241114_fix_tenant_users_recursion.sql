...
-- The issue was similar to super_admins - policies querying the same table they're protecting
...
CREATE POLICY "tenant_users_can_view_own_tenant_users_safe" ON tenant_users
    FOR SELECT USING (
...
CREATE POLICY "tenant_users_can_manage_tenant_users_safe" ON tenant_users
    FOR ALL USING (
